...
class NetTest  extends PHPUnit_Framework_TestCase{
    ...
    public function testQuery(){
        ...
        $firstSearch = $googleUrl->setLang('fr')->setNumberResults(10)->search("tshirt acdc");
        
        $adwords = $firstSearch->getAdwordsPositions();
        
        
        $this->assertTrue(count($adwords)>0);
        $this->assertEquals(10, $firstSearch->getPositions());
